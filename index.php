<?
$link = 'https://richplayland.com/2080/?refCode=wp_w34730p162_'.$_GET['clickid']; 
?>
<!DOCTYPE html>
<html lang="en">
...
<body dir="ltr">
    <main class="wrapper background-backgroundcolor">
        <section class="section">
            ...
            <h1 class="headline-text headline-fontcolor">ДОСТУП В КAЗИНО ДОСТУПЕН ТОЛЬКО СОВЕРШЕННОЛЕТНИМ</h1>
            <div class="message-text message-fontcolor">Вам уже исполнилось 18 лет?</div>
            <div class="call-to-action">
                <section class="button-section"> <a class="destination-target_url" id="destination_url" href="<?print $link;?>"> <button type="submit" class="action-button button button-shape button-backgroundcolor"> <span class="button-text button-fontcolor">Да, мне есть 18 лет</span> </button></a>
                </section>
            </div>
        </section>
    </main>
